...
resource "aws_s3_bucket_server_side_encryption_configuration" "logs" {
  ...
  rule {
    apply_server_side_encryption_by_default {
      sse_algorithm     = var.enable_s3_bucket_server_side_encryption_sse_algorithm
      kms_master_key_id = var.enable_s3_bucket_server_side_encryption_sse_algorithm == "aws:kms" ? var.s3_bucket_server_side_encryption_key : null
